...
Version  : 2.5.0
Release  : 6
URL      : https://github.com/edenhill/librdkafka/archive/v2.5.0/librdkafka-2.5.0.tar.gz
Source0  : https://github.com/edenhill/librdkafka/archive/v2.5.0/librdkafka-2.5.0.tar.gz
...
%prep
%setup -q -n librdkafka-2.5.0
cd %{_builddir}/librdkafka-2.5.0
pushd ..
cp -a librdkafka-2.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721335653
mkdir -p clr-build
pushd clr-build
