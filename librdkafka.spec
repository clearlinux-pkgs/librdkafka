...
Version  : 2.6.1
Release  : 10
URL      : https://github.com/edenhill/librdkafka/archive/v2.6.1/librdkafka-2.6.1.tar.gz
Source0  : https://github.com/edenhill/librdkafka/archive/v2.6.1/librdkafka-2.6.1.tar.gz
...
%prep
%setup -q -n librdkafka-2.6.1
cd %{_builddir}/librdkafka-2.6.1
pushd ..
cp -a librdkafka-2.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732049493
mkdir -p clr-build
pushd clr-build
