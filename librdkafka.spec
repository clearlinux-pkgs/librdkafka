...
Source0  : https://github.com/edenhill/librdkafka/archive/v2.10.0/librdkafka-2.10.0.tar.gz
...
%prep
%setup -q -n librdkafka-2.10.0
cd %{_builddir}/librdkafka-2.10.0
pushd ..
cp -a librdkafka-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744988949
mkdir -p clr-build
pushd clr-build
