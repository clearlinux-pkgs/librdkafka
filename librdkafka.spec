...
Version  : 2.8.0
Release  : 11
URL      : https://github.com/edenhill/librdkafka/archive/v2.8.0/librdkafka-2.8.0.tar.gz
Source0  : https://github.com/edenhill/librdkafka/archive/v2.8.0/librdkafka-2.8.0.tar.gz
...
%prep
%setup -q -n librdkafka-2.8.0
cd %{_builddir}/librdkafka-2.8.0
pushd ..
cp -a librdkafka-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736265876
mkdir -p clr-build
pushd clr-build
