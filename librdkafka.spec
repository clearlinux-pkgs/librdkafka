...
Version  : 2.4.0.3
Release  : 5
URL      : https://github.com/edenhill/librdkafka/archive/v2.4.0-3/librdkafka-2.4.0.3.tar.gz
Source0  : https://github.com/edenhill/librdkafka/archive/v2.4.0-3/librdkafka-2.4.0.3.tar.gz
...
%prep
%setup -q -n librdkafka-2.4.0-3
cd %{_builddir}/librdkafka-2.4.0-3
pushd ..
cp -a librdkafka-2.4.0-3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719970509
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.cjson %{buildroot}/usr/share/package-licenses/librdkafka/5c753d7bf6e7cf01c2dde51c78a18f640d405369 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.crc32c %{buildroot}/usr/share/package-licenses/librdkafka/1c729ec87a41f94eabbabb496454e54cf770c678 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.hdrhistogram %{buildroot}/usr/share/package-licenses/librdkafka/25c13cb8c65676499760570c0bb60538e34c6b90 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.lz4 %{buildroot}/usr/share/package-licenses/librdkafka/a4e718c02da9df0bc7fa137d001387bb264a3c90 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.murmur2 %{buildroot}/usr/share/package-licenses/librdkafka/199b0086de98cc0044deeedf89a7f819c9f9a5ce || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.pycrc %{buildroot}/usr/share/package-licenses/librdkafka/e8651e180555376b5c2b5ecd114981481a512546 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.queue %{buildroot}/usr/share/package-licenses/librdkafka/7f653fbf85dbdf0f48138299d18381a6bfb101f1 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.snappy %{buildroot}/usr/share/package-licenses/librdkafka/7e81b2429a98f39ef348b68a40eaac4b834f29a7 || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.tinycthread %{buildroot}/usr/share/package-licenses/librdkafka/14107287e77706772572744b1b3ecfde8960472d || :
cp %{_builddir}/librdkafka-2.4.0-3/LICENSE.wingetopt %{buildroot}/usr/share/package-licenses/librdkafka/e612d1fbaad7c0a278b025734f37cfa6bbb0b678 || :
cp %{_builddir}/librdkafka-2.4.0-3/packaging/cmake/Modules/LICENSE.FindZstd %{buildroot}/usr/share/package-licenses/librdkafka/b5ec887319537fbea3fa9804ac9a5cd5e40afd2e || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
